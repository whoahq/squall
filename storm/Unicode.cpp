...
ptrdiff_t STORMAPI SUniConvertCPToUTF16(const wchar_t* codepage, wchar_t* dest, const char* source, uint32_t destsize) {
...
ptrdiff_t STORMAPI SUniConvertUTF16ToCP(const wchar_t* codepage, char* dest, const wchar_t* source, uint32_t destsize) {
    if (destsize == 0) return 0;
